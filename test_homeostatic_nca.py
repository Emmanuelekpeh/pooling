...
# Import the homeostatic NCA from the main file
import sys
sys.path.append('.')

# We'll redefine the classes here to avoid import issues
...
def test_homeostatic_nca():
    ...
    print("Testing Homeostatic NCA System")
    print("=" * 50)
    ...
    # Summary
    print("\n" + "=" * 50)
    print("HOMEOSTATIC NCA TEST SUMMARY")
    print("=" * 50)
    ...
    if healthy_scenarios >= len(scenarios) * 0.6:
        print("\n✅ HOMEOSTATIC SYSTEM SHOWS PROMISE")
        print("The attention-based memory system demonstrates improved stability")
    elif stable_scenarios >= len(scenarios) * 0.4:
        print("\n⚠️ PARTIAL SUCCESS")
        print("Some stability improvements but bifurcation still present")
    else:
        print("\n❌ HOMEOSTATIC SYSTEM STILL UNSTABLE")
